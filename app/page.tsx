...
const translations = {
  es: {
    ...
    about_text: "Soy Daniel Villarreal, desarrollador de software enfocado en crear experiencias web y móviles modernas, funcionales y escalables. Me apasiona construir productos digitales centrados en claridad, rendimiento y experiencia de usuario.",
  ...
  en: {
    ...
    about_text: "I'm Daniel Villarreal, a software developer focused on building modern, functional, and scalable web and mobile experiences. I'm passionate about crafting digital products centered on clarity, performance, and user experience.",
    bento_frontend: "FRONTEND CORE",
