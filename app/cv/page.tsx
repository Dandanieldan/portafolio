    ...
    <div className="cv-page min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 p-0 md:p-8 flex flex-col items-center transition-colors duration-300">
      ...
      <div className="w-full max-w-[850px] bg-white dark:bg-zinc-900/30 border border-zinc-200/50 dark:border-zinc-800/50 shadow-[0_4px_30px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.2)] p-6 md:p-14 font-sans leading-relaxed text-zinc-800 dark:text-zinc-300 text-xs transition-colors duration-300 print:bg-white print:text-zinc-800 print:p-0 print:max-w-full">
        ...
        <div className="text-center pb-6 mb-6 print:pb-4 print:mb-4 border-b border-zinc-200 dark:border-zinc-800 print:border-zinc-200">
          ...
          <h2 className="text-xs md:text-sm font-mono tracking-widest uppercase mt-1.5 text-zinc-500 dark:text-zinc-400 print:text-zinc-500 font-semibold">
            {t.subtitle}
          </h2>
        ...
        {/* Profile / Summary */}
        <div className="mb-6">
          <p className="text-justify leading-relaxed text-zinc-700 dark:text-zinc-300 print:text-zinc-700 text-[11px] md:text-[12px]">
            {t.profile}
          </p>
        </div>
        ...
        {/* Skills Section */}
        <div className="mb-6">
          <h3 className="font-mono tracking-widest text-zinc-400 dark:text-zinc-500 print:text-zinc-500 border-b border-zinc-200 dark:border-zinc-800 print:border-zinc-200 pb-1 mb-3 print:mb-2 text-[10px] font-bold">
            {t.skillsTitle}
          </h3>
          <div className="space-y-2">
            {t.skills.map((skill, idx) => (
              <div key={idx} className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-1 md:gap-4 text-[11px] md:text-[12px]">
                <span className="font-bold text-zinc-900 dark:text-zinc-100 print:text-zinc-900 font-mono uppercase text-[10px] tracking-wider pt-0.5">{skill.name}</span>
                <span className="text-zinc-600 dark:text-zinc-400 print:text-zinc-600 leading-relaxed">{skill.desc}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Projects Section */}
        <div className="mb-6">
          <h3 className="font-mono tracking-widest text-zinc-400 dark:text-zinc-500 print:text-zinc-500 border-b border-zinc-200 dark:border-zinc-800 print:border-zinc-200 pb-1 mb-4 print:mb-3 text-[10px] font-bold">
            {t.projectsTitle}
          </h3>
            ...
            {t.projects.map((proj, idx) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:justify-between items-start md:items-baseline gap-1">
                  <span className="font-bold text-zinc-900 dark:text-zinc-100 print:text-zinc-900 text-xs md:text-sm">{proj.role}</span>
                </div>
                <div className="text-zinc-500 dark:text-zinc-450 print:text-zinc-500 font-mono text-[10px] uppercase tracking-wider mb-2">{proj.company}</div>
                <ul className="list-disc pl-4 space-y-1 text-zinc-600 dark:text-zinc-400 print:text-zinc-600 leading-relaxed">
          ...
          <div className="space-y-4">
            {t.experience.map((exp, idx) => (
              <div 
                ...
                className="hover:border-l-black dark:hover:border-l-white transition-all pl-0 md:pl-4 md:-ml-4 border-l-2 border-l-transparent text-[11px] md:text-[12px]"
              >
                <div className="font-bold text-zinc-900 dark:text-zinc-100 print:text-zinc-900 text-xs md:text-sm">{exp.role}</div>
                <ul className="list-disc pl-4 space-y-1 text-zinc-600 dark:text-zinc-400 print:text-zinc-600 leading-relaxed mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-zinc-200 dark:border-zinc-800 print:border-zinc-200 pt-6 print:pt-4">
          {/* Left Column: Education */}
          <div>
            <h3 className="font-mono tracking-widest text-zinc-400 dark:text-zinc-500 print:text-zinc-500 text-[10px] font-bold mb-3 print:mb-1">
              {t.educationTitle}
            </h3>
            <div className="space-y-4 text-[11px] md:text-[12px]">
              {t.education.map((edu, idx) => (
                <div key={idx}>
                  <div className="flex justify-between font-bold text-zinc-900 dark:text-zinc-100 print:text-zinc-900">
                    <span className="text-xs md:text-sm">{edu.degree}</span>
                    <span className="font-normal text-[10px] font-mono text-zinc-400 dark:text-zinc-500 print:text-zinc-500">{edu.date}</span>
                  </div>
                  <div className="text-zinc-500 dark:text-zinc-450 print:text-zinc-500 text-[10px] uppercase font-mono tracking-wider mt-0.5">{edu.school}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-4 space-y-1 text-zinc-600 dark:text-zinc-400 print:text-zinc-600 text-[11px] md:text-[12px] leading-relaxed">
